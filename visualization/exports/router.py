...
async def export_compliance_report(
    ...
    data = {
        ...
        "models": [
            {"id": "ThreatDetector-v3", "name": "Détection de Menaces v3", "risk_level": "High",
             "trust_score": 0.87, "compliance_status": "Compliant", "last_assessed": "2025-12-21"},
            {"id": "AnomalyClassifier-v2", "name": "Classifieur d'Anomalies v2", "risk_level": "Limited",
             "trust_score": 0.92, "compliance_status": "Compliant", "last_assessed": "2025-12-21"},
            {"id": "CyberSentinel-v1", "name": "CyberSentinel v1", "risk_level": "High",
             "trust_score": 0.78, "compliance_status": "Review Required", "last_assessed": "2025-12-20"},
        ],
        "findings": [
            {"severity": "Warning", "title": "Documentation gouvernance des données incomplète",
             "recommendation": "Mettre à jour la documentation de traçabilité des données"},
        ],
    }
