    ...
    def _generate_demo_dashboard_data(self, time_range: timedelta) -> UnifiedDashboardData:
        ...
        return UnifiedDashboardData(
            ...
            top_issues=[
                {
                    "id": "ISS-001",
                    "title": "Dérive sémantique détectée sur ThreatDetector-v3",
                    "severity": "warning",
                    "affected_service": "ThreatDetector-v3",
                    "duration_minutes": 45,
                },
                {
                    "id": "ISS-002",
                    "title": "Latence élevée sur corrélation IT/OT",
                    "severity": "warning",
                    "affected_service": "AnomalyClassifier-v2",
                    "duration_minutes": 20,
                },
                {
                    "id": "ISS-003",
                    "title": "Noeud edge Rennes — synchronisation dégradée",
                    "severity": "info",
                    "affected_service": "edge-rennes-02",
